...
export default function PersonalWebsite() {
  return (
    <div className="min-h-screen bg-neutral-950 text-white fade-in">
      {/* Hero / Identity */}
      <header className="max-w-6xl mx-auto px-6 pt-28 pb-20">
        <div className="max-w-4xl">
          <h1 className="text-5xl font-bold tracking-tight leading-tight">
            Nicholas Allen
          </h1>

          <p className="mt-4 text-xl text-neutral-300 leading-relaxed">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-4">
            <a
              ...
              className="inline-flex items-center justify-center px-6 py-3 rounded-md bg-white text-neutral-900 font-medium hover:bg-neutral-200 transition"
            >
              Download Resume (PDF)
            </a>
            ...
            <a
              href="/case-studies"
              className="inline-flex items-center justify-center px-6 py-3 rounded-md border border-neutral-700 text-white hover:bg-neutral-800 transition"
            >
              View Case Studies
            </a>
          </div>

          <div className="mt-10 text-sm text-neutral-400 space-y-1">
            <p>
              Email:{' '}
              <a
...
<section className="max-w-6xl mx-auto px-10 py-14 md:py-16">
  <h2 className="text-3xl font-semibold mb-8">Professional Summary</h2>

  <div className="max-w-4xl text-neutral-300 leading-relaxed">
    <p>
...
<section className="max-w-6xl mx-auto px-10 py-14 md:py-16">
  ...
  <ul className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 list-disc list-inside text-neutral-300">
...
<section className="max-w-6xl mx-auto px-10 py-14 md:py-16">
  ...
  <ul className="list-disc list-inside space-y-4 text-neutral-300 max-w-4xl">
    <li>
