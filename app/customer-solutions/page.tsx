    ...
    <div className="pl-10">
      ...
      <ul className="list-disc list-inside text-neutral-100 space-y-2">
        ...
        <div className="bg-transparent pl-10 pt-6 mb-6">
          <h3 className="text-xl font-medium">Restaurant General Manager</h3>
          <p className="text-sm text-neutral-400 mb-4">BDE LLC · Mar 2023 – Oct 2023</p>
          <ul className="list-disc list-inside text-neutral-100 space-y-2">
        ...
        <div className="bg-transparent pl-10 pt-6 mb-6">
          <h3 className="text-xl font-medium">Assistant Store Manager</h3>
          <p className="text-sm text-neutral-400 mb-4">Furman's Inc. · May 2015 – Jan 2019</p>
          <ul className="list-disc list-inside text-neutral-100 space-y-2">
